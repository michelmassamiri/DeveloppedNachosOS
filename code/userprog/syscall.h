...
/* 
 *PutChar write character to output system
 */
void PutChar(char ch);

/*
 *PutString write string to output system
 */
void PutString(const char s[]);

/*
 *GetChar read character from input system
 */
int GetChar();

/*
 *GetString read a string from input system
 */
void GetString();

/*
 *Create a new Thread whith two arguments f and arg
 */
int ThreadCreate(int f, void *arg);

/*
 *Terminate a Thread which running
 */
